...
var sequel = title + 'and Dem Boyz from da Hood';
...
var books = ['Catcher in the Rye', 'HTML and CSS and why to love them', 'Liquor Sales during the Pandemic', 'The Title of the Book is Made Up', 'Oh No I Have to Think of One More Title'];
...
var belowTwoHundred = [12, 23, 43, 121, 123, 11, 20, 56, 199, 10, 14, 34];

// Write the code to access the 5th element of the array, using bracket notation.

fifthNum = belowTwoHundred[4];
